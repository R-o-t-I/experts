...
return (
    <Panel id={id}>
        <PanelHeader
            left={<PanelHeaderBack onClick={go} data-to="categories"/>}
        >
            Арт
        </PanelHeader>
            <Div onClick={go} data-to="assessmentRulesArt">
                <ContentCard
            ...
            <Div onClick={go} data-to="chatRulersArt">
                <ContentCard
                    image=""
            ...
            <Div onClick={go} data-to="faqExpertArt">
                <ContentCard
