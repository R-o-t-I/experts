...
return (
    <Panel id={id}>
        <PanelHeader
            left={<PanelHeaderBack onClick={go} data-to="general" />}
        >
            Стикеры
        </PanelHeader>
           <Group>
                ...
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={eto_shedevr} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={vokrug_shum} />
                    </div>
                </Div>
                ...
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={geniy} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={boss} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={zhurnalist} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={kazanova} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={bender_1} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={bender_2} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={kopirayter} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={oldfag} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={pochet_i_uvazhenie} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={prodyusser} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={profi} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={szhech_ikh_vsekh_2} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={szhech_ikh_vsekh_3} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={ty_pytalsya} />
                    </div>
                </Div>
                <Div>
                    ...
                    <div className="stikers-block">
                        ...
                        <img onClick={go} data-to="achievements" className="achivments-stikers-img" src={tsar_vo_dvortsa} />
                    </div>
                </Div>
           </Group>
        </Panel>
